 ...
 */
public class FirebaseOtherFragment extends Fragment {
     ...
     * number.
     */
    public static FirebaseOtherFragment newInstance(int sectionNumber) {
        FirebaseOtherFragment fragment = new FirebaseOtherFragment();
